    ...
    <Layout>
      ...
      <Content class="main-content-con">
        <Layout class="main-layout-con">
          ...
          <Content class="content-wrapper" id="router_box">
            <!-- <router-view :key="$route.fullPath" /> -->
            <transition name="fade-transform" mode="out-in" v-on:enter="enter">
  ...
  methods: {
    ...
    style_padding_Y() {
      ...
      if (
        ...
        // 有滚动条
        if (this.now_padding == "20px 10px 20px 10px") return;
        document.getElementById("router_box").style.padding =
          " 20px 10px 20px 10px";
        this.now_padding = "20px 10px 20px 10px";
      } else {
        // 没滚动条
        if (this.now_padding == "20px 20px 20px 10px") return;
        document.getElementById("router_box").style.padding =
          " 20px 20px 20px 10px";
        this.now_padding = "20px 20px 20px 10px";
      }
    },
    enter(el, done) {
      if (
